...
// Use-case: Update date (by mistake)
...
SELECT * FROM OUR_FIRST_DB.public.test befort (statement => '019b9ef0-0500-8473-0043-4d830007309a');

TRUNCATE OUR_FIRST_DB.public.test;

INSERT INTO OURp_FIRST_DB.public.test
